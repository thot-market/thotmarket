...
/// Fixed-supply six-decimal test asset. Not USDC issued by Circle.
contract TestPayment {
    string public constant name="Anvil test dollars";
    ...
    constructor(address recipient,uint256 amount) { totalSupply=amount;balanceOf[recipient]=amount;emit Transfer(address(0),recipient,amount); }
